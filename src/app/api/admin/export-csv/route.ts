...
// Force le rendu dynamique pour éviter une tentative de pré-rendu au build.
...
/**
 * Helper : formate une ligne CSV. Échappe les guillemets et entoure de
 * doubles guillemets toute cellule contenant une virgule, un guillemet ou
 * un saut de ligne. Convertit null/undefined en chaîne vide.
 */
